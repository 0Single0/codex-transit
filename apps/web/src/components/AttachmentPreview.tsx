...
export function AttachmentPreview(props: { attachment: AttachmentItem }) {
  ...
  if (attachment.kind === "image" && attachment.previewUrl) {
    return (
      <figure className="overflow-hidden rounded-2xl bg-white/[0.04]">
  ...
  return (
    <div className="flex items-center gap-3 rounded-2xl bg-white/[0.04] px-3 py-3 text-sm text-slate-200">
